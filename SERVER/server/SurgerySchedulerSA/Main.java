...
public class Main {
    public static void main(String[] args) {
        ...
        // 讀取手術資料
        System.out.println("\n讀取手術資料...");
        List<Surgery> allSurgeries = DataLoader.loadSurgeries("TimeTable.csv");
        ...
        // 讀取手術室資料
        System.out.println("\n讀取手術室資料...");
        List<OperatingRoom> allRooms = DataLoader.loadRooms("room.csv", regular, overtime, cleaning);
        ...
        DataLoader.assignInitialSchedule(allRooms, allSurgeries, "LPT"); // 可選 FCFS、LPT或SPT
        ...
        System.out.println("新班表已寫入 newTimeTable.csv");
    }
}
