        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          <div className="w-20 h-20 mb-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="w-full h-full">
              ...
              <rect x={cross.horizontal.x} y={cross.horizontal.y} width="30" height="8" rx="4" fill="#0d6efd"
                transform={`rotate(${currentTime.getMinutes() * 6}, ${cross.horizontal.x + 15}, ${cross.horizontal.y + 4})`} />
              <rect x={cross.vertical.x} y={cross.vertical.y} width="8" height="30" rx="4" fill="#0d6efd"
        ...
        {!passwordChanged ? (
          <div className="space-y-6 relative z-10">
            <div>
              ...
              />
              {error.newPassword && <p className="text-sm text-red-600 mt-1">{error.newPassword}</p>}
            </div>
            ...
            <div>
              ...
              />
              {error.newPasswordAgain && <p className="text-sm text-red-600 mt-1">{error.newPasswordAgain}</p>}
              {error.passwordNotEqquals && <p className="text-sm text-red-600 mt-1">{error.passwordNotEqquals}</p>}
            </div>
            ...
            <div className="flex justify-between items-center pt-2">
              <button className="text-sm text-blue-700 hover:underline" onClick={() => togglePage("loginPage")}>
                返回登入
              </button>
